  ...
  return (
    <>
      <div className="fixed z-30 w-8/12 flex flex-col gap-3 items-end bottom-2 right-2 md:hidden">
        ...
        <button
          onClick={toggleMenu} // This way of calling a function only works if the function is stord in a const.
          className="text-white rounded-md flex items-center gap-2 bg-gray-900 px-3 py-1"
        >
