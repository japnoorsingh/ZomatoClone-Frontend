...
import { MapContainer, TileLayer, Marker, Popup } from "react-leaflet"; // Marker -> Location marker on map | Popup -> Restaurant title that will popup when we hover/click on the marker
