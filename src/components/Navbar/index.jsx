  ...
  return (
    <div className="flex w-full items-center justify-between lg:hidden">
      ...
      <div className="flex items-center gap-3 relative">
        ...
        {reduxState?.fullName ? ( // If we have user data and init if we hve fullName, then display the following fragment
          <>
            <div
            ...
            {isDropDownOpen && ( // Both conditions true: dropdown open and there is a user, i.e, signed in user
          ...
          <>
            <span
              onClick={() => setIsDropDownOpen((prev) => !prev)} // Set it opposite to its previous state i.e., true <-> false
